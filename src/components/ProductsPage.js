    ...
    <div className="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
      <div className="rounded overflow-hidden shadow-lg">
        ...
        <div className="flex px-6 pt-4 pb-2 justify-between">
          ...
          <a onClick={(e)=>{add()}} className="inline-block bg-yellow-500 rounded-full px-3 py-1 text-lg font-semibold text-gray-700 mr-2 mb-2 cursor-pointer hover:bg-yellow-300">
            Add to Cart
          </a>
        </div>
      </div>
